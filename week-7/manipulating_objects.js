...
//
//I had trouble passing the terah.eyeColor property.  I tried to call delete as a method on terah using dot notation, which did not work of course, because this is not Ruby.  So, I changed it to delete terah.eyeColor, which did work because that is how you properly call that function in JS according to Eloquent JavaScript.
//
//It was very easy to add and delete properties outside the object itself.  Dot notations is super fast and intuitive.

//I learned that you can manipulate objects outside of the object itself very easily, even several levels deep (as with Terah's children).  Pretty cool.
